 ...
 */
public class EditPengeluaranGUIFORM extends javax.swing.JFrame {
...
//   private PengeluaranGUI main;
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        // TODO add your handling code here:\\
    id_pengeluaran = Integer.parseInt(IDLabel.getText());
    jumlah_pengeluaran = Integer.parseInt(Jumlahfield.getText());
    tanggal_pengeluaran = date.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
    note = Notefield.getText();

    try {
        id_kategori_pengeluaran = pilihanKategori.getKategoriId(CBkategori.getSelectedItem().toString());
        Pengeluaran pengeluaran = new Pengeluaran(id_pengeluaran, id_kategori_pengeluaran, jumlah_pengeluaran, tanggal_pengeluaran, note);
        int rowsAffected = pengeluaranStorage.updatePengeluaran(pengeluaran);
        if (rowsAffected > 0) {
    ...
    public EditPengeluaranGUIFORM(int id_pengeluaran, int id_kategori_pengeluaran, int jumlah_pengeluaran, LocalDate tanggal_pengeluaran, String note) {
        initComponents();
...
//  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditPengeluaranGUIFORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditPengeluaranGUIFORM().setVisible(true);
            }
        });
    }
