 ...
 */
public class EditPemasukkanGUIFORM extends javax.swing.JFrame {
...
//   private PengeluaranGUI main;
    ...
    try {
        id_kategori_pemasukkan = pilihKategori.getKategoriId(CBkategori.getSelectedItem().toString());
    ...
    public EditPemasukkanGUIFORM(int id_pengeluaran, int id_kategori_pengeluaran, int jumlah_pengeluaran, LocalDate tanggal_pengeluaran, String note) {
        initComponents();
        this.id_pemasukkan = id_pengeluaran;
        this.id_kategori_pemasukkan = id_kategori_pengeluaran;
...
//  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditPemasukkanGUIFORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditPemasukkanGUIFORM().setVisible(true);
            }
        });
    }
